...
import { Sprout, Menu, X, LayoutDashboard, ChevronDown, Sun, Moon, User as UserIcon, Phone } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
        ...
        >
          <div className="w-9 h-9 bg-green-600 rounded-lg flex items-center justify-center text-white shadow-lg">
            <Sprout size={20} />
          </div>
