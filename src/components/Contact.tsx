      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Ready to transform your outdoor space? Contact Grandpa Ron's Lawn and Landscape 
            for professional landscaping services in Canal Winchester, Ohio.
          </p>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-gray-600">info@grandparons.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="text-gray-900 font-medium">Service Area</p>
                    <p className="text-gray-600">Canal Winchester, OH & Surrounding Areas</p>
                  </div>
                </div>
              </div>
            </div>
