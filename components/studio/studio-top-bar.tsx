...
import { useStudio, type StudioMode, type ProjectView } from '@/app/dashboard/studio/layout';
...
export function StudioTopBar() {
  const { mode, setMode, projectView, setProjectView, snapshot } = useStudio();
    ...
    <SurfaceHeader
      ...
      leftContent={
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-muted-foreground/70">Moon</span>
