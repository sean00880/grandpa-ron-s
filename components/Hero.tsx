  ...
  return (
    <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center" style={{ transform: `translateY(${offset * 0.2}px)` }}>
        ...
        <h1 className="font-heading font-normal text-6xl md:text-7xl lg:text-8xl mb-8 leading-none text-white tracking-tight animate-fade-in-up shadow-black drop-shadow-lg">
          Professional <br />
        ...
        <p className="font-subheading text-lg md:text-2xl text-zinc-200 mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-100 drop-shadow-md">
        ...
        <div className="max-w-2xl mx-auto mb-12 animate-fade-in-up delay-150">
          {!isLocationExpanded ? (
            <button
              ...
              className="w-full max-w-md mx-auto bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md border-2 border-white/20 rounded-full px-6 py-4 text-zinc-900 dark:text-white font-semibold hover:bg-white dark:hover:bg-zinc-900 transition-all shadow-2xl flex items-center justify-between"
            >
